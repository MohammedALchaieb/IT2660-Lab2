...
class Lab2 {
  ...
  public void queue() {
    ...
    String removedElement = q.remove(); // removes head (FIFO)
  ...
  public void stack() {
    ...
    System.out.println("Top after pop (peek): " + bookStack.peek());
    ...
    System.out.println("Top after push (peek): " + bookStack.peek());

    // 18. Search for "Design Patterns" in the stack. Display the results of the search.
    int pos = bookStack.search("Design Patterns"); // 1-based from top, -1 if not found
    System.out.println("Search result for 'Design Patterns': " + pos);
